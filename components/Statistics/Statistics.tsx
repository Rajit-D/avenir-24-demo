...
const Statistics = () => {
  return (
    <div className="w-full mt-5 flex md:flex-row flex-col md:justify-around justify-center items-center bg-opacity-40 z-2 backdrop-brightness-200 backdrop-blur-[1.7px] bg-black">
