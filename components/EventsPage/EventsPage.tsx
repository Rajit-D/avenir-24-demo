...
const EventsPage = ({ eventData, eventCategory }: Props) => {
  ...
  return (
    <div className="text-white pt-8 md:mt-[99.41px] w-dvw h-auto md:h-[calc(100dvh-99.41px)] flex justify-center items-between bg-opacity-20 z-2 backdrop-brightness-100 backdrop-blur-[1.7px]">
