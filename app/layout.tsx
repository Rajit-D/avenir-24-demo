...
export const metadata: Metadata = {
  ...
  icons:'https://www.avenirnsec.live/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.a2374b39.png&w=1920&q=75',
  openGraph:{
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head><link rel="icon" href="/assets/phnxlogo.png" type="image/png" sizes="any" /></head>
